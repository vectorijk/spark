...
class GeneralizedLinearRegression(JavaEstimator, HasLabelCol, HasFeaturesCol, HasPredictionCol,
    ...
    def __init__(self, labelCol="label", featuresCol="features", predictionCol="prediction",
                 ...
                 solver="irls", family="gaussian", link="identity"):
        """
        ...
        self._setDefault(fitIntercept=True, maxIter=25, tol=1e-6, regParam=0.0, weightCol=None,
                         solver="irls", family="gaussian")
        kwargs = self.__init__._input_kwargs
        self.setParams(**kwargs)
